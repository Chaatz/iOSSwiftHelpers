...
//  chaatz
//
//  Created by Mingloan Chan on 15/3/2016.
...
extension UIAlertController {
    ...
    static func presentAlertController(
        ...
        guard let viewController = fromViewController else { debug_print("cannot present alert view due to no presenting view controller."); return }
    ...
    @objc static func presentFailureAlert(title: String?, message: String?, fromViewController: UIViewController?) {
        ...
        guard let viewController = presentingViewController else { debug_print("cannot present alert view due to no presenting view controller."); return }
